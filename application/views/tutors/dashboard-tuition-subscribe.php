    ...
    <?php $this->load->view('tutors/tutor-dash-sidebar'); ?>
      <div class="col-sm-10">
          <div class="col-sm-12 bg-wh no-padd m-t-10">
           <h4 class="title-hd"><strong>Tuition Subscribed</strong></h4>
            ...
            <!--looping part in foreach -->
             ...
             <div class="col-sm-12 inner-bg m-t-10 no-padd tutor-de pd10">
               <div class="col-sm-4">
                ...
                <div class="b-b1"></div>
                 <div class="col-sm-4">
                  ...
                  <h4>Timings :<b><?php echo $row->time;?></b> </h4>
               </div> 
                 <div class="col-sm-4">
              ...
              <h4>Syllabus :<b><?php echo $row->syllabus_name;?><b></h4>
                 ...
                 <div class="col-sm-4">
                  <h4>Class :<b><?php echo strtoupper($row->class_name);?></b> </h4>
                  <h4>Gender :<b><?php echo ucfirst($row->gender);?></b> </h4>
                 
               </div>
                 <div class="col-sm-4">
             
                  <h4>mobile:<b><?php echo $row->mobile;?></b> </h4>
               
               </div>
                 <div class="col-sm-4">
                    <h4>Subject :<b><?php echo $row->subjects;?></b> </h4>
                
                 </div>
                 <div class="col-sm-12">
                 <h4>Location : <b><?php echo ucwords($row->location);?></b></h4>
                 </div>
             </div>      
              <?php 
                                }
                               ...
                               <p class="text-danger"style="text-align:center">Records NOT Found....</p>
                             <?php } ?>
                              </div> 
