...
<form>
         ...
         <div class="col-sm-12 text-center">
             <div class="clearfix">&nbsp;</div>
             <div class="clearfix">&nbsp;</div>
           <button type="button" class="btn btn-warning no-bod-rad col-sm-4 col-sm-offset-4 btn-lg" id="next1"> Next</button>
         </div>
        </div>
    </div>
 ...
 <div class="form-group col-sm-12">
  ...
  <?php echo form_error('location'); ?>
      ...
      <div class="col-sm-12 text-center">
             <div class="clearfix">&nbsp;</div>
             <div class="clearfix">&nbsp;</div>
           <button type="button" class="btn btn-warning no-bod-rad col-sm-4 col-sm-offset-4 btn-lg" id="next2"> Next</button>
         </div>
         <div class="clearfix">&nbsp;</div>   
    </div>
    ...
    else if (location!="" && !loc_pattern.test(location))
    {
      ...
      else
      {
       ...
       if(tutor==29 || tutor==30)
       {
        ...
        {
          flag=false;
           $('#subject').css('border','10px solid yellow');
