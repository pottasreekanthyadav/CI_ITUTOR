...
<link rel="canonical" href="<?php echo base_url(); ?>tutor/idcard" />
<!-- Bootstrap -->
 ...
 ?>
        ...
        ?>
          ...
          <div class="col-sm-10 col-sm-offset-1">
            <?php echo form_open('tutor/store_tutor_delivery_address',array('id'=>'fromdelivery','name'=>'fromdelivery')); ?>
                <div class="clearfix">&nbsp;</div>
              <div class="form-group col-sm-6">
                <label> Name </label>
                <input type="text" name="recivername" id="recivername" class="form-control no-bod-rad" placeholder="Enter Name" maxlength="100" value="<?php echo $user_name; ?>">
              ...
              <!--end-->
               <div class="form-group col-sm-6">
                ...
                <input type="text" name="nameoncard" id="nameoncard" class="form-control no-bod-rad" placeholder="Enter Name on card" autocomplete="off" value="<?php echo set_value('nameoncard'); ?>" maxlength="60">
                 <span><?php echo form_error('nameoncard'); ?></span>
              </div>
              <div class="clearfix">&nbsp;</div>
                <div class="form-group col-sm-6">
                <label> Mobile </label>
                <input type="text" name="recivermobile" id="recivermobile"  class="form-control no-bod-rad" placeholder="Enter Mobile" autocomplete="off" maxlength="10" value="<?php echo $mobile; ?>">
                <span><?php echo form_error('recivermobile'); ?></span>
              </div>
                <div class="form-group col-sm-6">
                
                <label> Email </label>
                <input type="text" name="reciveremail" id="reciveremail" class="form-control no-bod-rad" placeholder="Enter Email" autocomplete="off" value="<?php echo $email; ?>">
                <span><?php echo form_error('reciveremail'); ?></span>              
              </div>
                <div class="clearfix">&nbsp;</div>
               <div class="form-group col-sm-6">
                <label> State </label>
                <input type="text" name="state" id="state" class="form-control no-bod-rad" placeholder="Enter State" autocomplete="off" maxlength="100" value="<?php echo set_value('state'); ?>">
                <span><?php echo form_error('state'); ?></span>
              </div>
               <div class="form-group col-sm-6">
                <label> City/District </label>
                <input type="text" id="city" name="city" class="form-control no-bod-rad" placeholder="Enter City/District" autocomplete="off" maxlength="100" value="<?php echo set_value('state'); ?>">
                <span><?php echo form_error('city'); ?></span>
              </div>
                <div class="clearfix">&nbsp;</div>
                <div class="form-group col-sm-6">
                   <label> Pincode </label>
                <input type="text" name="pincode" id="pincode" class="form-control no-bod-rad" placeholder="Enter Pincode" autocomplete="off" maxlength="6" minlength="6" value="<?php echo set_value('pincode'); ?>">
                <span><?php echo form_error('pincode'); ?></span>
              </div>
              <div class="form-group col-sm-6">
               <label> Landmark </label>
                <input type="text" name="landmark" id="landmark" class="form-control no-bod-rad" placeholder="Enter Landmark" autocomplete="off" maxlength="100" value="<?php echo set_value('pincode'); ?>">
                <span><?php echo form_error('landmark'); ?></span>
              </div>
                <div class="clearfix">&nbsp;</div>
               <div class="form-group col-sm-12">
                <label> Address </label>
                <textarea class="form-control no-bod-rad" id="address" name="address" rows="3" placeholder="Enter Name"></textarea> 
