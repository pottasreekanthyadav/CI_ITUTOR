  ...
  <section>
    ...
    <?php $this->load->view('tutors/tutor-dash-sidebar'); ?>
      <div class="col-sm-10">
          ...
          <div class="col-sm-12">
           <!--start-->
           <form name="frmsearch" id="frmsearch" action="<?php echo base_url(); ?>tutor/search_list_requirement" method="post" class="form-inline">
            <input type="text" name="searchby_string" class="form-control" id="searchby_string" placeholder="Search here by typing.">
            ...
            <select name="searchby_syllabus" id="searchby_syllabus" class="form-control">
            ...
            <select name="searchby_category" id="searchby_category" class="form-control"> 
             ...
             <select name="searchby_class" id="searchby_class" class="form-control"> 
                                      ...
                                      <!-- <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php //echo $row->id;?>"> </td> -->
                                       <td><?php echo ++$i; ?> </td>
                                        ...
                                        <td id="parent-<?php echo $row->id; ?>" class="hidden"><?php echo $row->parentid; ?></td>
                                         ...
                                         <td><a href="#" class="btn btn-info" onclick="viewleads(<?php echo $row->id; ?>,<?php echo $row->parentid; ?>)" data-toggle="modal" data-target="#myModalleadsview">View</a></td>
                                         <td><?php //if($row->no_of_response>0){ ?><a href="#" class="btn btn-info" onclick="populate_more('<?php echo $row->id;?>')" data-toggle="modal" data-target="#myModalfeedbackview">Feedback</a><?php //} ?></td>
