 ...
 <section>
      ...
      <div class="col-sm-10">
          <div class="col-sm-12 inner-bg no-padd m-t-10">
           ...
           <h4 class="title-hd"><strong>Basic Plan status</strong></h4>
                           ...
                           $payment_recs = $plandata[0];
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-success"><b> <?php if ($payment_recs->payment_status == 1) {
                                                    echo "<b style='color:green'>Life Time Plan is Active</b>";
                                                } elseif($payment_recs->payment_status == 0) {
                                                    echo "<b style='color:red'>Inactive</b>";
                                                } ?>   </b></td>
                                                <td><?php echo $res->expire;?> Years</td>
