...
<link rel="canonical" href="<?php echo base_url(); ?>tutor/change-password" />
<!-- Bootstrap -->
 ...
 <!--menu-->
  ...
  <section>
   ...
   <?php $this->load->view("tutors/tutor-dash-sidebar");?>
    ...
    echo form_open('tutors/Tutor/change_password',$attr);
    ?>
  ...
  <div class="form-group">      
      ...
      <div class="col-sm-offset-5 col-sm-7">
        <button type="submit" name="btn_change_password" class="btn btn-bg col-sm-4 no-bod-rad">Update</button>
      </div>
           <div class="clearfix">&nbsp;</div>
    </div>
  <?php
