 ...
 <section>
      ...
      <div class="col-sm-10">
          <div class="col-sm-12 inner-bg no-padd m-t-10">
           ...
           <h4 class="title-hd"><strong>ID Card tatus</strong></h4>
  ...
  <h4 class="col-wh"><?php echo $amount;?>/-</h4>
        </div>
        <div class="col-sm-7 col-xs-6">
          <h2 class="m-t-10 f26">Pay for Id Card from itsmytutor. <a href="#" class="pay-more"><span class="f14">Know more</span></a></h2>
        </div>
        <div class="col-sm-4 col-xs-2">
          <a href="<?php echo base_url(); ?>payment/2"><button type="button" class="btn btn-red col-wh  no-bod-rad col-sm-8 col-sm-offset-2" style="margin-top: 9px;">Start Now</button></a>
        </div>
      </div>
      
    </div><a href="<?php echo base_url(); ?>tutor/idcard">Delivery address for ID card</a>
