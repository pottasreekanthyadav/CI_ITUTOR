...
<!--custom css-->
 ...
 <!--menu-->
  ...
  <section>
      ...
      <div class="col-sm-10">
          <div class="col-sm-12 no-padd inner-bg m-t-10">
             
           <h4 class="title-head"><strong>Update Profile</strong></h4>
      <div class="col-sm-10">
              <fieldset class="the-fieldset col-sm-12">
                  <legend class="the-legend">Profile Details :</legend>
                  <div class="col-sm-12"> 
...
<!--                        <div class="fcbtn btn btn-info btn-outline btn-1e  no-bod-rad">-->
  <p style="font-size: 13px !important;margin-bottom: 4px !important;" class="site-col"><strong>Selected Categories : </strong><?php echo common_str($row->cats);?></p>
<!--</div>-->
                <?php
                       }
                     }
    ...
    <select class="form-control selectpicker no-bod-rad"  name="category[]" id="category"
    ...
    foreach($cat as $row)
    {
      ...
      //                  {
?>
      <option value="<?php echo $row->category_id;?>"><?php echo ucwords($row->category_name);?></option>
    <?php
    // }
  }
  }
...
<div class="col-sm-6">
  ...
  <p style="font-size: 13px !important;
    margin-bottom: 4px !important;" class="site-col"><strong>Selected Language"</strong><?php echo common_str($row->langs);?></p>
   ...
   <select class="form-control no-bod-rad" name="language[]" id="language" multiple="multiple" style="height: 120px; overflow: auto;" tabindex="" >
    ...
    {
      ?>
      <option value="<?php echo $row->lid;?>"><?php echo ucfirst($row->language);?></option>
      <?php
    }
}
    ?>
...
<?php } } ?>
  ...
  <p style="font-size: 13px !important;
    margin-bottom: 4px !important;margin-top: 16px;" class="site-col"><strong>Selected Syllabus: </strong><?php echo common_str($row->syllabus);?></p>
   ...
   <select class="form-control" name="syllabus[]" id="syllabus" tabindex="4" multiple="multiple">
    ...
    {                 
      ?>
      <option value="<?php echo $row->syllabus_id;?>"><?php echo strtoupper($row->syllabus_name);?></option>
      <?php
      }
  }
    ?>
  ...
  <p style="font-size: 13px !important;
    margin-bottom: 4px !important;margin-top: 16px;" class="site-col"><strong>Selected Subject: </strong><?php echo common_str($row->subjects);?></p>
   ...
   <select class="form-control" name="subject[]" id="subject" tabindex="3" multiple="multiple">
    <option value="" disabled="disabled">--select--</option>
    <?php
    foreach($res as $row)
    {
      ...
      ?>
      <option value="<?php echo $row->subject_id;?>"><?php echo ucfirst($row->subject_name);?></option>
   <?php
}
    ?>
  </select>
...
<div class="form-group col-sm-6">
  ...
  <input type="text" class="form-control" name="location" id="location" placeholder="Enter location" onFocus="geolocate()" value="<?php echo $user_data->location_name;?>" >
  ...
  */?>
   ...
   <input type="email" class="form-control" name="email" id="email" value="<?php $email=$this->session->userdata('user_email'); if(!empty($email)) echo $email;?>" placeholder="abc@gmail.com" >
    ...
    <div class="form-group col-sm-12">
          <div class="form-group sky-form">
            <label>About you(Min 200 Character)<sup>*</sup></label>
              <textarea class="form-control" name="about" id="about"><?php if(!empty($user_data->about_tutor)) echo set_value('about',$user_data->about_tutor);?></textarea>
          </div>
