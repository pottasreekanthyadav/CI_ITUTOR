...
<link rel="canonical" href="<?php echo base_url(); ?>tutor/query" />
<!-- Bootstrap -->
 ...
 <section>
      ...
      <div class="col-sm-10">
          ...
          <div class="col-sm-12">
            <?php if($this->session->flashdata('success')) { ?>
                                ...
                                <?php } ?>
           <form class="form-horizontal" method="post" action="<?php echo base_url();?>tutor/query">
    <div class="col-sm-8 col-sm-offset-2">
    <div class="clearfix">&nbsp;</div>
        <label>Subject</label>
        <input type="text" class="form-control no-bod-rad" id="subject" placeholder="Enter subject" name="tutor_subject">
    
    </div>
      <div class="col-sm-8 col-sm-offset-2"> 
          <div class="clearfix">&nbsp;</div>
      <label>Your Query</label>         
        <textarea id="query" name="tutor_query" class="form-control no-bod-rad" rows="6" cols="50" style="resize:none"></textarea>
    </div>
    ...
    <div class="form-group">      
      ...
      <div class="col-sm-offset-5 col-sm-7">
          <div class="clearfix">&nbsp;</div>
        <button type="submit" class="btn btn-bg col-sm-4 no-bod-rad" name="send">Submit</button>
