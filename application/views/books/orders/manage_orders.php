  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-12 col-sm-12 ">
        ...
        <div class="col-md-12">
        <form method="post" class="form-inline" action="<?php echo base_url(); ?>books/manage-orders">
          <input type="text" name="search" id="search" placeholder="Search by Order Number" class="form-control" value="<?php echo set_value('search'); ?>">
                        ...
                        <tbody>
                          ...
                          ?>
                                  ...
                                  $i++;
                                   ...
                                   ?>
                                <tr><td colspan="10" style="text-align:center; color:red;font-size:20px;">No Order Found...</td></tr>
                              <?php } ?>
