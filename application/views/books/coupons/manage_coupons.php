<?php //echo $coupon_result?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Itutor | Manage Coupons</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-12 col-sm-12 ">
        ...
        <div class="col-md-12">
        <form method="post" class="form-inline" action="<?php echo base_url(); ?>books/manage-coupons">
          <input type="text" name="search" id="search" placeholder="Search by coupon code" class="form-control" value="<?php echo set_value('search'); ?>">
           <input type="submit" class="btn btn-md btn-info" value="Search" id="search_btn">
        </form>
        </div>
        <form class="form-inline" action="<?php echo base_url()?>books/update-coupon" method="post">
        <div class="col-md-12 form-inline">
          <div class="col-md-5"></div>
          <div class="col-md-7" align="right" style="margin-top:6px;">
          <a  class="btn btn-primary btn-md" href="<?php echo base_url(); ?>books/add-coupons">Add Coupon</a>
          ...
          <button  class="btn btn-warning btn-md" name="inactive">In  Active </button>                    
           ...
           <span style="margin-right: 4px;"><a class="btn btn-primary  btn-md" href="<?php echo base_url(); ?>books/manage-coupons" title="Refresh"><i class="fa fa-refresh"></i></a></span>
        </div>
          </div>
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          ...
                          $segment = $this->uri->segment(4);
                            $i = $segment+1;
                            $newresult = json_decode($coupon_result);
                            if ($newresult->code == SUCCESS_CODE) {
                                foreach ($newresult->common_result as $row) {
                          ?>
                         <tr class="">
                              <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->coupon_id; ?>"> </td>
                              <td><?php echo $i; ?> </td>
                              ...
                              ?> 
                                ...
                                ?>
                                <b style='color:red'>Inactive</b></b></td>
                          <?php }?>
                              <td><?php  
                              if($row->valid_till < date('Y-m-d')){
                                echo "<b style='color:red'>Expired</b>";
                              }
                              else{
                                echo "<b style='color:blue'>Valid</b>";
                              }
                              ?>
                        ...
                        ?>
                        <tr><td colspan="10" style="text-align:center; color:red;font-size:20px;">No Coupons Found...</td></tr>
                    <?php
                      }
                      ?>
                        </tbody>
