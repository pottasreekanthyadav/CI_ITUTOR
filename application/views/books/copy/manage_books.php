...
<head>
  ...
  <title>Itutor | Manage books</title>
    ...
    <section class="content">
      ...
      <div class="col-md-12 col-sm-12 ">
        ...
        <option value=''>Select Category</option>
            ...
            <select name='subcategory' id='subcategory' class ='form-control' placeholder= 'Select subcategory'>
              <option value=''>--Choose Subcategory--</option>
            </select>
            <select name='status' id='status' class ='selectpicker form-control input-md' placeholder= 'Select Status'>
        ...
        <form class="form-inline" action="<?php echo base_url()?>books/update_book_status" method="post">
        <div class="col-md-12 form-inline">
          <div class="col-md-5"></div>
          <div class="col-md-7" align="right" style="margin-top:6px;">
          <a  class="btn btn-primary btn-md" href="<?php echo base_url(); ?>books/import_books"> Import sheet </a>
          
          <button  class="btn btn-success btn-md" name="active"> Active </button>
          <button  class="btn btn-warning btn-md" name="inactive">In  Active </button>                    
           <span onclick="return confirm('Confirm to delete')"><button  class="btn btn-danger  btn-md" name="delete"> Delete </button></span>
         
           <span style="margin-right: 4px;"><a class="btn btn-primary  btn-md" href="<?php echo base_url(); ?>books/manage_books" title="Refresh"><i class="fa fa-refresh"></i></a></span>
           <a href="<?php echo base_url(); ?>books/add_books" class="btn btn-primary pull-right">Add New</a>
        </div>
          </div>
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          <?php
                            ...
                            $i = $segment+1;
                            $books_list = json_decode($books_list);
                            if ($books_list->code == SUCCESS_CODE) {
                                foreach ($books_list->books as $row) {
                                    ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->book_id;?>"> </td>
                                        <td><?php echo $i; ?> </td>
                                        ...
                                        <td><img src="<?php echo base_url(); ?>uploads/books/books_images/<?php echo $row->image; ?>" style="width: 40px;height: 40px;"></td>
                                        <td><?php if($row->availability_type == 1){echo 'Library'; }elseif($row->availability_type == 2){echo 'Sell';}elseif($row->availability_type == 3){echo "Library & Sell"; }?></td>
                                        <td><?php if($row->familiarity_type == 1){echo "New arrival" ; }elseif($row->familiarity_type == 2){echo "Award winning"; }elseif($row->familiarity_type == 3){echo "Most read"; } ?></td>
                                        <td><?php $added_on=$row->added_on; echo date("d-M-Y", strtotime($added_on));?></td>
                                        <td class="text-success"><b> <?php if ($row->status == 1) {
