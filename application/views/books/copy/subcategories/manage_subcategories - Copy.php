  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-12 col-sm-12 ">
        ...
        <div class="col-md-7">
        <form method="post" class="form-inline" action="<?php echo base_url(); ?>books/manage_subcategories">
           ...
           <input type="search" name="search" class="form-control" placeholder="Sub category title" value="<?php echo set_value('search'); ?>">
           <input type="submit" class="btn btn-md btn-info" value="Search" id="search_btn">
        </form>
        </div>
        <div class="col-md-5 form-inline">
          <button  class="btn btn-success btn-md" onclick="updateActivationStatus('1','subcategories')"> Active </button>
          <button  class="btn btn-warning btn-md"  onclick="updateActivationStatus('0','subcategories')">In  Active </button>                    
           <span onclick="return confirm('Confirm to delete')"><button  class="btn btn-danger  btn-md" onclick="  ('subcategories');"> Delete </button></span>
           <span><a  class="btn btn-primary  btn-md" href="<?php echo base_url(); ?>books/manage_subcategories" title="Refresh"><i class="fa fa-refresh"></i></a></span>
           <div class="col-md-1">
           <a href="<?php echo base_url(); ?>books/add_subcategory" class="btn btn-primary pull-right">Add New</a></div>
        </div>
                          ...
                          <?php
                            ...
                            if ($newresult->code == SUCCESS_CODE) {
                                foreach ($newresult->common_result as $row) {
                                    ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->subcategory_id;?>"> </td>
                                        <td><?php echo $i; ?> </td>
                                        <td><?php echo $row->category_title; ?></td>
                                        <td><?php echo $row->title; ?></td>
                                        <td><?php if($row->subcategory_status){?><img src="<?php echo base_url(); ?>uploads/books/subcategories/<?php echo $row->image; ?>" style="width: 40px;height: 40px;"><?php }?></td>
                                        <td><?php echo $row->subcategory_priority; ?></td>
                                        <td><?php $added_on=$row->created_on; echo date("d-M-Y", strtotime($added_on));?></td>
                                        <td class="text-success"><b> <?php if ($row->subcategory_status == 1) {
                                                    echo "<b style='color:green'>Active</b>";
                                                } elseif($row->subcategory_status == 0) {
                                ...
                                <tr><td colspan="10" style="text-align:center; color:red;font-size:20px;">No Sub categories Found...</td></tr>
                            <?php }
                            ?>
                        </tbody>                     
                    </table>
