...
<p style='color:red;'>Click On Below Link To Reset Your Password</p>
<a href='<?php echo $url; ?>'
style='background:blue;color:#ffffff'>Click here
</a>
</div>
</div>
    <button type="button" style="padding: 10px 20px;background: #0a91d9; color: #fff;margin-bottom: 15px;margin-top: 10px"><a href="http://itsmytutor.com"> Contact us</a></button>
</div>
