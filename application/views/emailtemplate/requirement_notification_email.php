...
<p>Parent Name::<?php echo $emaildata->name; ?></p>
<p>Subject Name::<?php echo $emaildata->subjectname; ?></p>
<p>Syllabus Name::<?php echo $emaildata->syllabus_name; ?></p>
<p>Category Name::<?php echo $emaildata->category_name; ?></p>
<p>Class Name::<?php echo $emaildata->class_name; ?></p>
<p>Client Estimated budget.<?php echo 'Rs.'.$emaildata->budget_price.' '.$emaildata->budget_type; ?></p>
