...
<title> Contact  for Enquiry</title>
</head>
...
<div style="float: right"> 
    <p style="margin-top: 40px;margin-right: 33px"> Call : +91 9676372122  </p>
...
<div style="background: #e8e2e2;padding: 1px;text-align: center;margin:0px 50px">
    ...
    <p>Mobile : <a href="#"><?php echo $user_details['mobile']; ?></a></p>
</div>
...
<div style="background: #e8e2e2;padding: 5px;text-align: left;margin:10px 40px 0px">
    ...
    <p><?php echo $user_details['time']; ?></p>
    <p><?php echo $user_details['message']; ?></p>
    
       
    
</div>
</div>
    <a href="<?php echo base_url();?>contact" target="_blank"><button type="button" style="padding: 10px 20px;background: #0a91d9; color: #fff;margin-bottom: 15px;margin-top: 10px"> Contact us</button>
</div>
