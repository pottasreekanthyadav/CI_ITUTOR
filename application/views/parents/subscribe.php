...
<!--  <link href="css/font-awesome.min.css" rel="stylesheet" />-->
  <link href="https://use.fontawesome.com/releases/v5.0.8/css/all.css" rel="stylesheet">
    ...
    <![endif]-->
    <style>
        .sub-head { border: 1px solid #ccc}
.sub-head h3{padding: 15px 10px;background-color: #2279a2; color: #fff;margin-top: 0px}
      </style>
 ...
 <div class="container">
   <div class="col-sm-12">
    <div class="col-sm-5 col-sm-offset-1 text-center">
        <div class="sub-head">
        <h3>Subscribe Plan &amp; Get Leads</h3>
        <div class="clearfix">&nbsp;</div> 
            <p><img src="<?php echo base_url(); ?>/assets/images/tick.png"> Lorem Ipsum is simply dummy text </p>  
            <p><img src="<?php echo base_url(); ?>/assets/images/tick.png"> Lorem Ipsum is simply dummy text </p>
            <p><img src="<?php echo base_url(); ?>/assets/images/tick.png"> Lorem Ipsum is simply dummy text </p>
            <p><img src="<?php echo base_url(); ?>/assets/images/tick.png"> Lorem Ipsum is simply dummy text </p>
                <div class="clearfix">&nbsp;</div> 
            <a href="<?php echo base_url().'Registration/get_plans';?>"><input type="submit" class="btn col-sm-4 col-sm-offset-4 btn-bg" value="Subscribe Now"></a>
             <div class="clearfix">&nbsp;</div>   <div class="clearfix">&nbsp;</div>  
        </div>
          </div> 
            <div class="col-sm-5 text-center">
        <div class="sub-head">
        <h3>Access By Free SignUp</h3>
        <div class="clearfix">&nbsp;</div> 
            <p><img src="<?php echo base_url(); ?>/assets/images/tick.png"> Lorem Ipsum is simply dummy text </p>  
            <p><img src="<?php echo base_url(); ?>/assets/images/tick.png"> Lorem Ipsum is simply dummy text </p>
            <p><img src="<?php echo base_url(); ?>/assets/images/tick.png"> Lorem Ipsum is simply dummy text </p>
            <p><img src="<?php echo base_url(); ?>/assets/images/tick.png"> Lorem Ipsum is simply dummy text </p>
                <div class="clearfix">&nbsp;</div> 
          <a href="<?php echo base_url();?>tutors/Tutor/load_dashboard"><input type="submit" class="btn col-sm-4 col-sm-offset-4 btn-bg" value="Access"></a>
             <div class="clearfix">&nbsp;</div>   <div class="clearfix">&nbsp;</div>  
        </div>
          </div>
