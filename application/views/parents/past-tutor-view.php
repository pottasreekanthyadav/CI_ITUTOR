    ...
    <?php $this->load->view('parents/parent-sidebar'); ?>
      <div class="col-sm-10">
          <div class="col-sm-12 inner-bg no-padd m-t-10">
           ...
           <h4 class="title-hd"><strong>Viewed Tutors</strong></h4>
                        ...
                        <div class="col-md-12 filter-right-main-head">
                            ...
                            <div class="col-md-12">
                              ...
                              <ul class="list-inline text-center">
                                ...
                                <li class="col-md-4">
                                  <a href="<?php echo base_url();?>frontend/tutor_profile_ctrl/<?php echo $row->user_id;?>" class="btn btn-red no-bod-rad f14 text-white" style="margin-left: 20px;padding: 9px 20px;width:150px">View profile</a></li>
                                  <li class="col-md-4">
                                <a href="#" class="btn btn-blue no-bod-rad f14 text-white" onclick="viewtutor(<?php echo $row->user_id; ?>)" data-toggle="modal" data-target="#myModalleadsview" style="margin-left: 80px;padding: 9px 20px;width:150px">View contact</a>
                                  </li>
