...
<head>
  ...
  <title>Itutor | Manage vendor</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-12 col-sm-12 ">
        ...
        <div class="col-md-7">
        <form method="post" class="form-inline" action="<?php echo base_url(); ?>inventory/manage_vendor">
        <input type="search" name="search" class="form-control" placeholder="Vendor name/Vendor code" value="<?php echo set_value('search'); ?>">
        <input type="submit" class="btn btn-md btn-info" value="Search">
        </form>
        </div>
        <div class="col-md-5 form-inline">
          <button  class="btn btn-success   btn-md" onclick="updateActivationStatus('1','vendor')"> Active </button>
          <button  class="btn btn-warning   btn-md"  onclick="updateActivationStatus('0','vendor')">In  Active </button>                    
           <span onclick="return confirm('Confirm to delete')"><button  class="btn btn-danger  btn-md" onclick="updateActivationStatus('2','vendor');"> Delete </button></span>
           <span><a  class="btn btn-primary  btn-md" href="<?php echo base_url(); ?>inventory/manage_vendor" title="Refresh"><i class="fa fa-refresh"></i></a></span>
           <div class="col-md-1">
           <a href="<?php echo base_url(); ?>inventory/add_vendor" class="btn btn-primary pull-right">Add New</a></div>
        </div>
                          ...
                          <?php
                            ...
                            if ($newresult->code == SUCCESS_CODE) {
                                foreach ($newresult->common_result as $row) {
                                    ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->vendor_id;?>"> </td>
                                        <td><?php echo $i; ?> </td>
                                        ...
                                        <td class="text-success"><b> <?php if ($row->vendor_status == 1) {
                                ...
                                <tr><td colspan="10" style="text-align:center; color:red;font-size:20px;">No Vendors Found...</td></tr>
                            <?php }
                            ?>
