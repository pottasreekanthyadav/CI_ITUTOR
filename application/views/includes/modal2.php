<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <form id="formrequirement" method="post" action="#">
         <div class="print-error-msg" style="text-align:center"></div>
             
            <div class="form-group col-sm-6">
            <label>Name of Student</label>
           <input type="text" class="form-control" name="name" id="learn_name" placeholder="Enter Name of Student">
            <p id="learn_name_error"></p>
           </div> 
           <div class="form-group col-sm-6">
            <label>Email</label>
            <>
           <input type="text" class="form-control" name="email" id="learningemail" placeholder="Enter Email">
           <p id="learningemail_error"></p>
           </div>
           <div class="form-group col-sm-6">
            <label>Mobile</label>
           <input type="text" class="form-control" name="mobile" id="learningmobile" maxlength="10" minlength="10" placeholder="Enter mobile" >
           <p id="learningmobile_error"></p>
           </div>
           <div class="form-group col-sm-6">
        ...
        <select id="syllabus" name="syllabus" class="form-control">
          ...
          <p id="categorie_error"></p>
           ...
           <select id="subjects" name="subjects[]" class="form-control subjects" multiple>
          ...
          //  }
           ...
           <input type="text" class="form-control" id="searchlocation" name="searchlocation" placeholder="Enter Your Location">
