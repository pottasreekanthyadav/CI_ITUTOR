...
.panel-title > a:focus  {
  ...
  <?php $this->load->view('includes/header'); ?>
   ...
   <section>
       ...
       <img src="<?php echo base_url();?>assets/images/banner-cat-wise.jpg" class="img-responsive" style="width:100%;height:300px" alt="itutors" />
          </div>
        </div>
<div class="clearfix">&nbsp;</div>
      </div>
    ...
    <div class="container-fluid">
      <div class="container">
        <div class="col-sm-8">
         ...
         <img src="<?php echo base_url();?>assets/images/sub-cat/1.png" class="img-responsive" style="width:100%;height:200px;padding: 5px;" alt="itutors" />
          </div>
          <div class="col-sm-9">
