    ...
    <section class="content">
      <div class="row">
        ...
        <form method="post" class="form-inline" action="">
			     <input type="search" name="search" class="form-control" placeholder="email or mobile">
           <input type="submit" name="submit"class="btn btn-md btn-info" value="Search">
        </form>
            ...
            <div class="box-body">
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  $page=$this->uri->segment(4);
                            ...
                            $i=1;
                        foreach($support_recs as $row)
                        {
                          ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]"
                                        value="<?php echo $row->tutor_support_id;?>"> </td>
                                        <td><?php echo $i; ?> </td>
                                        <td><?php echo $row->mobile; ?></td>
                                        <td><?php echo $row->email;?></td>
                                   <?php $string=$row->query;
                                   $append_string=$string;
                                  ?>
                                  <p style="display:none" id='mydescreption<?php echo $row->tutor_support_id; ?>'><?php echo $append_string;?></p>
                                  <?php
...
?>
                            ...
                            <td class="footable-visible"><?php echo $string; ?><?php if(strlen($string)>50){ ?><a  data-toggle="modal" data-target="#myModal12" href="#" onclick="populate_more('<?php echo $row->tutor_support_id; ?>')" class="text-primary bb"><b>Read More</b></a><?php } ?></td>
                                ...
                                <td><?php 
                                echo date('d-m-Y',strtotime($row->added_on));?></td>

                                        <td>
                                            <a href="<?php echo base_url();?>admin/tutor/tutor_support_delete_ctrl/<?php echo $row->tutor_support_id;?>" onclick="javascript:return confirm('Are you sure to delete');" class="btn btn-danger btn-xs "><i class="fa fa-trash-o" aria-hidden="true"></i> Delete </a>
                                ...
                                <tr><td colspan="10" style="text-align:center; color:red;font-size:20px;">Record Not found</td></tr>
                            <?php }
                            ?>
              ...
              <td colspan="4" > <p class="pages"><?php if(!empty($support_links)) echo $support_links; ?></p></td>
              </div>
                    </div></div></div>
            </div>
            <!-- /.box-body -->
