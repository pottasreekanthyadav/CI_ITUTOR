...
<head>
  ...
  <title>Itutor | Add Employee QR codes</title>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <h3 class="box-title">Add New Employee QR Codes</h3>
            <a href="<?php echo base_url(); ?>QR_code/manage_employee_qrcodes" class="btn btn-primary pull-right">Manage Employee QR Codes</a>
            </div>
                <!-- /.panel-heading -->
          ...
          <div class="col-md-4">
              <div class="form-group">
               <?php $data5 = array(
                        ...
                        echo form_label('Name') . " <span style='color:red' id='price_err'> *".form_error('price')."</span>";
             ...
             <div class="col-md-4">
              <div class="form-group">
               <?php $data5 = array(
                        ...
                        echo form_label('Email') . " <span style='color:red' id='price_err'> *".form_error('price')."</span>";
                        echo form_input($data5);
                        ?>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
               <?php $data5 = array(
                        ...
                        echo form_label('Mobile') . " <span style='color:red' id='title_err'> * ".form_error('title')."</span>";
                        echo form_input($data5);
                        ?>
            ...
            <div class="col-md-4">
              <div class="form-group">
               <?php $data5 = array(
                        ...
                        echo form_label('Qualification') . " <span style='color:red' id='stock_err'> *".form_error('stock')."</span>";
                        echo form_input($data5);
                        ?>
              </div>
            </div>  
            <div class="col-md-4">
              <div class="form-group">
               <?php $data5 = array(
                        ...
                        echo form_label('Experience') . " <span style='color:red' id='price_err'> *".form_error('price')."</span>";
                        echo form_input($data5);
                        ?>
              </div>
            </div>   
   <div class="col-md-4">
              <div class="form-group">
               <?php $data5 = array(
                        ...
                        echo form_label('Password') . " <span style='color:red' id='stock_err'> *".form_error('stock')."</span>";
                        echo form_input($data5);
                        ?>
              </div>
            </div>			
         <div class="col-md-4"> 
              <div class="form-group">
                  <?php $data7 = array(
                   ...
                   echo form_label('Profile Pic')." <span style='color:red' id='image_error'> *".form_error('image')."</span>";
