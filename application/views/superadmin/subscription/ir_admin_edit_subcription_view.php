  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div cla  ss="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php $form_attributes = array('id' => 'subscription', 'name' => 'subscription');
                            
                            
                            $sid = $recs->subscription_id;
                            
                            echo form_open("superadmin/Subscription/update_subscription_ctrl2/$sid", $form_attributes);
            ...
            <div class="col-md-4">
              <div class="form-group">
                     <span style="color:red; " id="class_err"> *<?php echo form_error('tutor_id');?></span>
                            ...
                            <select name="category" id="classes" class="form-control ">
                                <option value="">Choose Class</option>
       
                                <?php 
                                foreach($cls as $category)
                                {
                                ?>
                              <option value="<?php echo $category->category_id; ?>" <?php if($category->category_id==$recs->category_id){echo "selected";} ?>><?php echo $category->category_name; ?></option>
                               <?php
                             }
                             ?>
                             </select>
            ...
            <div class="col-md-4">
              <div class="form-group">
               ...
               <?php $data3 = array(
                            ...
                            'class' => 'form-control',
                            'placeholder' => 'Price',
                            'value' => set_value('plan_amount',$amt)
      ...
      <div class="clearfix"></div>
            <div class="col-md-4">
              <div class="form-group">
                <?php if($recs) $validity = $recs->validity; ?>
              <?php
                        $data4 = array(
                            'name' => 'validity',
                            'id' => 'validity',
                            ...
                            'value' =>  set_value('validity',$validity)
                        );
                        echo form_label('Validity'). "<span style='color:red' id='validity_err'>* ".form_error('validity')."</span>"?>
      ...
      <div class="clearfix"></div>
            <div class="col-md-4">
              <div class="form-group">
                <?php if($recs) $number_of_tuitions = $recs->no_of_tutions; ?>
              <?php
                        $data4 = array(
                            ...
                            'value' =>  set_value('number_of_tuitions',$number_of_tuitions)
                        );
 ...
 <script>
      ...
      if(classes==''|| classes==' '){
       ...
       if(tuition==''|| tuition==' '){
                ...
                $('#tuition_err').html(' Please Enter no. of tuituons');
       }
