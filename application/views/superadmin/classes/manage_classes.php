      ...
      <div class="col-md-12 col-sm-12 ">
        ...
        <div class="col-md-5 form-inline">
          ...
          <button  class="btn btn-success   btn-md" onclick="updateActivationStatus('1')"> Active </button>
           ...
           <div class="col-md-1">
           <a href="<?php echo SUPER_ADMIN_FOLDER_PATH; ?>Classes/addClassView" class="btn btn-primary pull-right">Add New</a></div>
        </div>
                            ...
                            if ($newresult->code == SUCCESS_CODE) {
                                foreach ($newresult->result as $row) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-success"><b> <?php if ($row->class_status == 1) {
                                                    echo "<b style='color:green'>Active</b>";
                                                } elseif($row->class_status == 0) {
                                                    echo "<b style='color:red'>Inactive</b>";
                                                } ?>   </b></td>
                                                <td><input  style="color:black;width:50px;margin:5px;border-radius:5px;padding:0px 5px 0px 5px" type="text" name="priority[]"  value="<?php echo $row->class_priority;?>" style="width:50px" class="number-class" /><span class="hide"></span></td>
                                             <td> 
                                            <a href="<?php echo base_url(); ?>superadmin/Classes/getClasses/<?php echo $row->class_id; ?>" class="btn btn-sm btn-warning "> Update <i class="glyphicon glyphicon-upload"> </i> </a><br/><br/>
                                        </td>
                                    </tr> 
                                    <?php $i++;
                                }
