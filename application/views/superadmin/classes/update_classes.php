          ...
          <div class="box box-primary">
            ...
            <a href="<?php echo SUPER_ADMIN_FOLDER_PATH;?>Classes/manageClasses" class="btn btn-primary pull-right">Manage Class</a>
                ...
                <div class="panel-body">
                                ...
                                ?>
                  <?php echo form_open('superadmin/Classes/updateClasses',array('id'=>'form_data')); ?>
                                        <div class="col-md-8 input_fields_wrap"> 
                                            <div class="navbar-form">
                                            <input type="hidden" id="class_id" name="class_id" value="<?php echo $data->class_id;?>"/>
                                              ...
                                              <select id="category" name="category" class="input_small class_form form-control">
                                                  ...
                                                  <?php if(is_array($category_data) || is_object($category_data)){
                                                    foreach($category_data as $key=>$value){
                                                      ?>
                                                   <option value="<?php echo $value->category_id; ?>"  <?php if($data->category_id== $value->category_id){ echo 'selected'; } ?>><?php echo $value->category_name; ?></option>
