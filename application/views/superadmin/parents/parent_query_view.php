                        ...
                        foreach($support_recs as $row)
                        {
                          ?>
                                    <tr class="">
                                        ...
                                        value="<?php echo $row->parent_support_id;?>" </td>
                                        <td><?php echo $i; ?> </td>
                                  ...
                                  ?>
                                  <p style="display:none" id='mydescreption<?php echo $row->patrent_support_id; ?>'><?php echo $append_string;?></p>
                                  <?php
...
?>
                            ...
                            <td class="footable-visible"><?php echo $string; ?><?php if(strlen($string)>50){ ?><a  data-toggle="modal" data-target="#myModal12" href="#" onclick="populate_more('<?php echo $row->parent_support_id; ?>')" class="text-primary bb"><b>Read More</b></a><?php } ?></td>
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'parent_support','updatelist':checklist},
