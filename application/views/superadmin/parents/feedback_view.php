  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Parent Feedback</li>
      </ol>
    </section>
...
<form method="post" action="<?php echo base_url();?>superadmin/parent_feedback/parent_search_feedback">
           <div class="col-sm-2">
                            ...
                            if (!empty($common_result)) {
                                foreach ($common_result as $row) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td><?php echo $row->tutor_mobile;?></td>
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'parent_feedback', 'updatelist': checklist, 'activity': s},
                url: '<?php echo base_url(); ?>superadmin/Parent_feedback/commonStatus/',
                success: function (u) {
                    console.log(u);
                    if(u.code=='200'){$('#success').show();$('#success').html(u.description).addClass('alert alert-success');setTimeout(function() {window.location=location.href;},1000);}
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'parent_feedback','updatelist':checklist},
          url:'<?php echo base_url();?>superadmin/Parent_feedback/commonDelete/',
          success:function(u){
           // console.log(u);
