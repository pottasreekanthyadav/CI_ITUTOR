  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Parent Leads</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-3 form-inline">
          ...
          <button  class="btn btn-success   btn-md" onclick="updateActivationStatus('1')"> Active </button>
            <button  class="btn btn-warning   btn-md"  onclick="updateActivationStatus('0')">Inactive</button>  
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          <?php
                            $i = 1;
                            if (!empty($leads_recs)) {
                                foreach ($leads_recs as $row) {
                                    ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->track_id;?>"> </td>
                                        <td><?php echo $i;?></td>
                                        ...
                                        <td class="text-success"><b> <?php if ($row->status == 1) {
                                                    echo "<b style='color:green'>succcess</b>";
                                                } elseif($row->status == 0) {
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'parent_leads', 'updatelist': checklist, 'activity': s},
                url: '<?php echo base_url(); ?>superadmin/Parent_leads/commonStatus/',
                success: function (u) {
                    console.log(u);
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'parent_leads','updatelist':checklist},
          url:'<?php echo base_url();?>superadmin/parent_leads/commonDelete',
          success:function(u){
           // console.log(u);
