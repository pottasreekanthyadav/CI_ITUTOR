...
<?php $this->load->view("superadmin/includes/header.php");?>
 <!-- Left side column. contains the logo and sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <?php $updated_res=json_decode($result);
     // print_r($updated_res);
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <?php
                            ...
                            echo form_open('superadmin/ClassSubjects/updateClassSubDetails', $form_attributes);
                         ?>
            <div class="box-body">
            <div class="col-md-4">
                            ...
                            <select name="classes" id="classes" class="form-control ">
                                ...
                                if ($class_res->code == SUCCESS_CODE) {
                                    foreach ($class_res->class_list as $class_response) {
                                        ?>
                                        <option value="<?php echo $class_response->class_id; ?>" <?php if($class_response->class_id==$updated_res->class_data[0]->class_id) echo "selected" ?>><?php echo $class_response->class_name; ?></option>
                                        <?php
                                    }
                                }
                                ?>
                            ...
                            <span style="color:red; " id="subject_err"> *</span> <br>&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                if ($subject_res->code == SUCCESS_CODE) {
                                    foreach ($subject_res->subject_list as $subject_response) {
                                        ...
                                        <input type="checkbox" name="subjects[]" value="<?php echo $subject_response->subject_id; ?>" <?php $sub_ids=explode(',',$updated_res->class_data[0]->subject_ids);
                                        for($j=0; $j<count($sub_ids); $j++){if($subject_response->subject_id == $sub_ids[$j]) echo "checked";}?>>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $subject_response->subject_name; ?>
                                        </div>
                                        <?php
            ...
            <input type="hidden" name="class_id" id="class_id" 
                              value="<?php echo $updated_res->class_data[0]->class_id ?>">
