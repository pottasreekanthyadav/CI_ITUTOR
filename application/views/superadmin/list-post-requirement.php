...
<option value="<?php echo $value->syllabus_id; ?>" <?php echo set_select('searchby_sybllabus',$searchdata_syll, False); ?> ><?php echo $value->syllabus_name; ?></option> 
                   <?php   } }
                      ?>
                   </select>
                 </div> 
...
<option value="<?php echo $value->class_id; ?>" <?php echo set_select('searchby_class', $value->class_id, False); ?> ><?php echo $value->class_name; ?></option> 
                 ...
                 <div class="col-sm-1">
            <input type="submit" name="search" id="search" class="btn btn-md btn-info" value="Search">
         </div>
         <?php echo form_close(); ?>
         <div class="col-sm-3">
