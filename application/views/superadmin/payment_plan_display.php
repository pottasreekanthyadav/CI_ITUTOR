  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-12 col-sm-12 ">
        ...
        <div class="col-md-5 form-inline" style="display:none">
          ...
          <button  class="btn btn-success   btn-md" onclick="updateActivationStatus('1')"> Active </button>
           ...
           <div class="col-md-1">
           <a href="<?php echo SUPER_ADMIN_FOLDER_PATH; ?>payment/payment_plan_add" class="btn btn-primary pull-right">Add New</a></div>
        </div>
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th>Amount</th>
                                 <th>No.Of Access</th>
                                 <th>Tutor Day Access </th>
                                 <th>Tutor Monthly Access</th>
                                 <th>Tutor Yearly Access</th>
                                 <th>Parent Weekly Access</th>
                                 <th>Parent Yearly Post</th>
                                 <th>Expire In</th>
                                  <th>GST</th>
                                <th>Added Date</th>
                                <th>updated_on</th>
                        ...
                        <tbody>
                           <?php
                            ...
                            if (!empty($plan_recs)) {
                                foreach ($plan_recs as $row) {
                                    ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->id;?>"> </td>
                                        <td><?php echo $i; ?> </td>
                                        <td><?php echo ucwords($row->plan_name);?></td>
                                        <td><?php echo $row->amount; ?></td>
                                         <td><?php echo $row->access; ?></td>
                                      <td><?php echo $row->tutor_day_access;?></td> 
                                     <td><?php echo $row->tutor_monthly_access;?></td> 
                                     <td><?php echo $row->tutor_yearly_access;?></td> 
                                     <td><?php echo $row->parent_weekly_access;?></td>
                                     <td><?php echo $row->parent_yearly_post;?></td> 

                                         <td><?php echo $row->expire;?> years</td>
                                      ...
                                      <td><?php $updated_on=$row->updated_on; echo date("d-M-Y", strtotime($updated_on));?></td>
                                        <td class="text-success"><b> <?php if ($row->status == 1) {
                                             ...
                                             <td> 
                                            <a href="<?php echo base_url(); ?>superadmin/payment/update_plan/<?php echo $row->id; ?>" class="btn btn-sm btn-warning "> Update <i class="glyphicon glyphicon-upload"> </i> </a><br/><br/>
                                        </td>
                                    </tr> 
                                    <?php $i++;
                                }
                            } else { ?>
                                <tr><td colspan="10" style="text-align:center; color:red;font-size:20px;">Plan NotFound...</td></tr>
                            <?php }
                            ?>
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'classes', 'updatelist': checklist, 'activity': s},
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'classes','updatelist':checklist},
