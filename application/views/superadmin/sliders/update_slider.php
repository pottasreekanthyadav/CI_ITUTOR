...
<head>
  ...
  <title>Ghar Aahaar | Slider </title>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            $attribute = array('name' =>'form' ,'id'=> 'register-form');
               echo form_open_multipart('superadmin/Category/updateSlider',$attribute); ?>
            <div class="box-body">
            <div class="col-md-4">
...
<script>
   $("#btn_submit").click(function(){
      ...
      $('#span_title,#span_url').html('');
      $('#slider_title,#slider_url').css('border','');
      if(title==''|| title==' '){
          str=false;
