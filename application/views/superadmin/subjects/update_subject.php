          ...
          <div class="box box-primary">
            ...
            <a href="<?php echo SUPER_ADMIN_FOLDER_PATH;?>Subjects/manageSubjects" class="btn btn-primary pull-right">Manage Subjects</a>
                ...
                <div class="panel-body">
                                ...
                                ?>
                  <?php echo form_open('superadmin/Subjects/updateSubjects',array('id'=>'form_data')); ?>
                                  <div class="col-md-8 input_fields_wrap"> 
                                      <div class="navbar-form">
                                      <input type="hidden" id="subject_id" name="subject_id" value="<?php echo $data->subject_id;?>"/>
                                          <?php echo form_label('Subject Name','Subject Name')."<span style='color:red' id='subject_name'> * ".form_error('class_name')."</span> <br>";
