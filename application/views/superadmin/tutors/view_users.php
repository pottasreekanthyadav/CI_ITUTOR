...
<?php $this->load->view("superadmin/includes/header.php");?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Manage Registered Tutors
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Registered Tutors</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <form method="post" class="form-inline">
			     <input type="search" name="search" class="form-control" placeholder="name or mobile or email">
            ...
            <div class="box-body">
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            if ($result->code == SUCCESS_CODE) {
                                foreach ($result->common_result as $row) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-success"><b> <?php if ($row->user_status == 1) {
                                                    echo "<b style='color:green'>Active</b>";
                                                } elseif($row->user_status == 0) {
                                                    echo "<b style='color:red'>Inactive</b>";
                                                } ?>   </b></td>
                                                <td><?php echo date('d-m-Y',strtotime($row->registered_on));?></td>
                                        
                                    </tr> 
                                    <?php $i++;
                                }
                            } else { ?>
                                <tr><td colspan="10" style="text-align:center; color:red;font-size:20px;">No Tutor Found...</td></tr>
                            <?php }
                            ?>
                         ...
                         <button class="btn-btn info"><a href="<?php echo base_url();?>/superadmin/tutor/get_users_csv" style="color:green">download csv file</a></button>
                    </table>
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'registered_tutor', 'updatelist': checklist, 'activity': s},
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'registered_tutor','updatelist':checklist},
