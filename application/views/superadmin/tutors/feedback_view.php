  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tutor Feedback</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          ?>
      <form method="post" action="<?php echo base_url();?>superadmin/tutor/tutor_search_feedback">
          <div class="clearfix">&nbsp;</div>
          <div class="clearfix">&nbsp;</div>
           <div class="col-sm-2">
              <input type="text" name="all_search" class="form-control" placeholder="email or mobile">
              </div>
           <div class="col-sm-2">   
            ...
            <select class="form-control" name="meeting">
              <option value="">Select Metting Status</option>
            ...
            <input type="submit" name="search" class="btn btn-md btn-info" value="Search">
               ...
               <div class="col-md-4">
         <button  class="btn btn-success" onclick="updateActivationStatus('1')"> Approve </button>
            <button  class="btn btn-warning"  onclick="updateActivationStatus('0')">Dissmiss</button>  
            ...
            <div class="box-body">
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          <?php
                            $i = 1;
                            // $result = count($common_result);
                            //print_r($common_result);
                            if (!empty($common_result)) {
                                foreach ($common_result as $row) {
                                    ?>
                                    <tr>
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->feedback_id;?>"> </td>
                                        <td><?php echo $i;?></td>
                                        ...
                                        <td><?php echo ucwords($row->feedback);?>
                                        <td class="text-success"><b> <?php if ($row->feedstatus == 1) {
                                                    echo "<b style='color:green'>Approved</b>";
                                                } elseif($row->feedstatus == 0) {
                                                    echo "<b style='color:red'>Disallowed</b>";
                                                } ?>   </b></td>
                                            <td><?php echo date('d-m-Y',strtotime($row->feed_created_date));?></td>
                                        
                                    </tr> 
                                    <?php $i++;
                                }
                            } else { ?>
                                <tr><td colspan="10" style="text-align:center; color:red;font-size:20px;">Feedback Not Found</td></tr>
                            <?php }
                            ?>
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'tutor_feedback', 'updatelist': checklist, 'activity': s},
                url: '<?php echo base_url(); ?>superadmin/Tutor/commonStatus_tutor_notification',
                success: function (u) {
                    console.log(u);
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'tutor_feedback','updatelist':checklist},
