                           ...
                           $result = json_decode($common_result);
                            ...
                            if ($result->code == SUCCESS_CODE) {
                                foreach ($result->common_result as $row) {
                                    ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo"hii";?>"> </td>
                                        <td><?php echo $i; ?> </td>
                                        <td><?php echo $row->refer_cash;?></td>
                                        ...
                                        <td><?php echo date('d-m-Y',strtotime($row->validity));?></td>
                                         <td><a href="<?php echo base_url(); ?>superadmin/refer/update_refer/<?php echo $row->id; ?>" class="btn btn-sm btn-warning "> Update <i class="glyphicon glyphicon-upload"> </i> </a></td><br/><br/>
                                    </tr> 
                                    <?php $i++;
                                }
                            } else { ?>
