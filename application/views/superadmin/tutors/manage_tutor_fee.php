      ...
      <div class="col-md-12 col-sm-12 ">
        ...
        <div class="col-md-5 form-inline">
          ...
          <button  class="btn btn-success   btn-md" onclick="updateActivationStatus('1')"> Active </button>
           ...
           <div class="col-md-1">
           <a href="<?php echo SUPER_ADMIN_FOLDER_PATH; ?>tutor_fee/view_fee" class="btn btn-primary pull-right">Add New</a></div>
        </div>
                                ...
                                foreach ($common_result as $row) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td><?php echo ucwords($row->category_name); ?></td>
                                         <td><?php echo ucwords($row->type_name); ?></td>
                                       ...
                                       <a href="<?php echo base_url(); ?>superadmin/Classes/getClasses/<?php echo $row->id; ?>" class="btn btn-sm btn-warning "> Update <i class="glyphicon glyphicon-upload"> </i> </a><br/><br/>
                                        </td>
                                    </tr> 
                                    <?php $i++;
                                }
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'tutor_fee', 'updatelist': checklist, 'activity': s},
                url: '<?php echo base_url(); ?>superadmin/tutor_fee/commonStatus/',
                success: function (u) {
                    console.log(u);
                    if(u.code=='200'){$('#success').show();$('#successmessage').html(u.description).addClass('alert alert-success');setTimeout(function() {window.location=location.href;},20);}
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'tutor_fee','updatelist':checklist},
          url:'<?php echo base_url();?>superadmin/tutor_fee/commonDelete/',
          success:function(u){
           // console.log(u);
