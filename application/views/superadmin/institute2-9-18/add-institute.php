...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="institutename" name="institutename" type="text" placeholder="Enter Institute Name" class="form-control input-md" required="" value="<?php echo set_value('institutename'); ?>" onchange="duplicate_restrict_institute()">
     <span id="institutename-error"><?php echo form_error('institutename', '<div class="text-danger">', '</div>'); ?></span>
     <p id="institutename-duplicate" style="color: red"></p>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input id="instituteemail" name="instituteemail" class="form-control input-md" type="text" value="<?php echo set_value('instituteemail'); ?>" placeholder="Enter Institute Email" onchange="duplicate_restrict_email()">
     <span id="instituteemail-error"><?php echo form_error('instituteemail', '<div class="text-danger">', '</div>'); ?></span>
      <p id="instituteemail-duplicate" style="color: red"></p>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input id="institutemobile" maxlength="10" name="institutemobile" class="form-control input-md" type="text" value="<?php echo set_value('institutemobile'); ?>" placeholder="Enter Institute Mobile" onchange="duplicate_restrict_mobile()">
     <span id="institutemobile-error"><?php echo form_error('institutemobile', '<div class="text-danger">', '</div>'); ?></span>
      <p id="institutemobile-duplicate" style="color: red"></p>
  </div>
</div>
<!-- Text input-->
<div class="form-group">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="gmap" name="gmap" type="text" placeholder="Keep Iframe map location of institute" class="form-control input-md" required="" value="<?php echo set_value('gmap'); ?>" autocomplete="off">
...
<script type="text/javascript">
  /*deulicate restrict ajax*/
  function duplicate_restrict_institute() {
    ...
    if(institutename!='' && institutename!=0){
      $.ajax({
        ...
        success:function(s){
          ...
          $("#institutename-duplicate").html(s.description);
          }
        },
        error:function(e) {
          console.log(e);
  ...
  /*duplicate restrict email ajax*/
  function duplicate_restrict_email() {
      ...
      $.ajax({
        ...
        success:function(s){
          ...
          if(s.code==200){
            $("#submit").prop('disabled',true);
          //  $('.enableOnInput').prop('disabled', true);
          $("#instituteemail-duplicate").html(s.description);
         // $("#instituteemail-error").html(s.description);
          }
        },
        error:function(e) {
          console.log(e);
  ...
  /*duplicate restrict email ajax*/
  function duplicate_restrict_mobile() {
      ...
      $.ajax({
        ...
        success:function(s){
          ...
          if(s.code==200){
            $("#submit").prop('disabled',true);
          //  $('.enableOnInput').prop('disabled', true);
          $("#institutemobile-duplicate").html(s.description);
          //$("#institutemobile-error").html(s.description);
          }
        },
        error:function(e) {
          console.log(e);
