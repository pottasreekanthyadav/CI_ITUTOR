          ...
          <div class="box box-primary">
            ...
            <a href="<?php echo SUPER_ADMIN_FOLDER_PATH;?>Tuitioncenter_controller/listing_institute_type" class="btn btn-primary pull-right">Manage Institute Type</a>
                ...
                <div class="panel-body">
                                ...
                                ?>
                  <?php echo form_open('superadmin/Tuitioncenter_controller/store_institute_type',array('id'=>'form_data')); ?>
                                    ...
                                    <div class="col-md-2 col-md-offset-1 "> 
                                             <div class="form-group">
                                                ...
                                                <input type="submit" name="btn_submit" value=" Submit " class="btn btn-md btn-success " id="btn_submit">
                                                 <a href="" class="btn btn-md btn-primary " id="btn_back"> Back </a>
                                            </div>
                                        </div>     
                                    <?php echo form_close();?>
                               </div>
        ...
        if(str == true){
            // data insert starts form hear 
             $.ajax({
                        ...
                        url: "<?php echo base_url(); ?>superadmin/Tuitioncenter_controller/store_institute_type",
                        contentType: false,
                        cache: false,
                        processData: false,
                            ...
                            switch (data.code)
                            {
                                ...
                                $('.success_msg').show();
                                    $('.success_msg').html(data.description).addClass('alert alert-success fade in');
                                      setTimeout(function () {
                                        window.location = "<?php echo base_url(); ?>superadmin/Tuitioncenter_controller/listing_institute_type";
                                    }, 3000);
                                    break;
                                case 204:
                                  $('.fail_msg').show();
                                    ...
                                    $('#btn_submit').show();
                                    setTimeout(function () {
                                        window.location = "<?php echo base_url();?><?php echo base_url(); ?>superadmin/Tuitioncenter_controller/add_institute_type";
                                    }, 3000);
                                case 301:
                                case 422:
                                case 575:
