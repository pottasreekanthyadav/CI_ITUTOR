        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <?php
                            ...
                            echo form_open('superadmin/budget_controller/store_budget', $form_attributes);
                         ?>
               <?php
			...
			<div class="col-md-4">
                            ...
                            <select name="category" id="category" class="form-control" onchange="duplicate_restrict()">
                                ...
                                if(!empty($category->result))
                                {
                                  ...
                                  {
                                    ?>
                                    <option value="<?php echo $value->category_id; ?>" <?php echo set_select('category',$value->category_id) ?>>
            ...
            <div class="col-md-4">
             <div class="form-group">
                <?php echo form_label('Budget Type');
                            ?>
               <input type="text" name="budgetType" placeholder="Enter the budget" class="form-control" id="budgetType" value="">
