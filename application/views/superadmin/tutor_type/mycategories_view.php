...
<td></td>
                                        <td>
                                            <a href="<?php echo base_url();?>admin/categories/cat_update_ctrl1/<?php echo $row->category_id;?>" class="btn btn-sm btn-warning "> Update <i class="glyphicon glyphicon-upload"> </i> </a> <a href="<?php echo base_url();?>admin/categories/cat_delete_ctrl/<?php echo $row->category_id;?>" onclick="javascript:return confirm('Are you sure to delete');" class="btn btn-danger btn-xs "><i class="fa fa-trash-o" aria-hidden="true"></i> Delete </a>
