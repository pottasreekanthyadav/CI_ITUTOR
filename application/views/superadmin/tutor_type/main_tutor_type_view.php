  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Tutor Types</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-5 form-inline">
          ...
          <button  class="btn btn-success   btn-md" onclick="updateActivationStatus('1')"> Active </button>
           ...
           <div class="col-md-1">
           <a href="<?php echo SUPER_ADMIN_FOLDER_PATH; ?>main_tutor_type/add_main_tutor_type" class="btn btn-primary pull-right">Add New</a></div>
        </div>
                                ...
                                foreach ($result->common_result as $row) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-success"><b> <?php if ($row->status == 1) {
                                             ...
                                             <td> 
                                            <a href="<?php echo base_url(); ?>superadmin/main_tutor_type/get_tutor_type/<?php echo $row->id; ?>" class="btn btn-sm btn-warning "> Update <i class="glyphicon glyphicon-upload"> </i> </a><br/><br/>
                                        </td>
                                    </tr> 
                                    <?php $i++;
                                }
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'tutor_type', 'updatelist': checklist, 'activity': s},
                url: '<?php echo base_url(); ?>superadmin/main_tutor_type/commonStatus/',
                success: function (u) {
                    console.log(u);
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'tutor_type','updatelist':checklist},
          url:'<?php echo base_url();?>superadmin/main_tutor_type/commonDelete/',
          success:function(u){
           // console.log(u);
            if(u.code=='200'){$('#success').show();$('#success').html(u.description).addClass('alert alert-success');setTimeout(function() {window.location=location.href;},2000);}
                    if(u.code=='204' || u.code=='301' || u.code=='422'){$('#fail').show();$('#failmessage').html(u.description).addClass('alert alert-danger');}
