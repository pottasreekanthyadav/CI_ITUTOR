      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <h3 class="box-title">Add tutor type</h3>
            <a href="<?php echo SUPER_ADMIN_FOLDER_PATH;?>main_tutor_type/manageTutorType" class="btn btn-primary pull-right">Manage tutor type</a>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php
                            $form_attributes = array('id' => 'tutor_subtype', 'name' => 'tutor_subtype');
                            echo form_open('superadmin/main_tutor_type/insert_main_tutor_type', $form_attributes);
                         ?>
               <?php
            ...
            <div class="col-md-4">
              <div class="form-group">
               <?php $data3 = array(
                            ...
                            'value' =>  set_value('tutor_type')

                        );
                        echo form_label('Tutor type') . "<span style='color:red' id='type_err'> *".form_error('tutor_type')."</span>";
