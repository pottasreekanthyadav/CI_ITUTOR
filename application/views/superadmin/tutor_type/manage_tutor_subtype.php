  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb" style="display:none">
        ...
        <li class="active"> Manage Tutor Category Types </li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <tr>
          <td>
            <a href="<?php echo SUPER_ADMIN_LINK; ?>Tutor_newtype/add_tutor_subtype" class="btn btn-primary pull-right">Add New</a></div>
          </td>
        </tr>
        </table>
        </div>
      ...
      <div style="height: 35px;"></div>
            ...
            <div class="box-body">
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php
                        $i=1;
                          if(!empty($subtype_row))
                          {
                            foreach($subtype_row as $row)
                            {
                              ?>
                              <tr class="">
                                <td>
                                  <input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->tutor_type_id; ?> ">
                                </td>
                                <td><?php echo $i; ?></td>
                                <td><?php echo strtoupper($row->tutor_type); ?></td>
                                ...
                                <td>
                                  <a href="<?php echo base_url();?>superadmin/Tutor_newtype/get_update_tutor_subtype/<?php echo $row->tutor_type_id;?>" class="btn btn-sm btn-warning "> Update <i class="glyphicon glyphicon-upload"> </i> </a>

                                  <a href="<?php echo base_url();?>admin/tutor/tutor_delete_ctrl/<?php echo $row->tutor_type_id;?>" onclick="javascript:return confirm('Are you sure to delete');" class="btn btn-danger btn-xs "><i class="fa fa-trash-o" aria-hidden="true"></i> Delete </a>
                                   <?php
              if($row->status==0)
              {
              ?>
              <a href="<?php echo base_url();?>admin/tutor/tutor_update_status_ctrl/<?php echo $row->tutor_type_id; ?>/1" class="btn btn-info btn-xs "><i class="fa fa-pencil" aria-hidden="true"></i> Active</a>
              <?php
              }
              else
              {
                ?>
                <a href="<?php echo base_url();?>admin/tutor/tutor_update_status_ctrl/<?php echo $row->tutor_type_id; ?>/0" class="btn btn-info btn-xs "><i class="fa fa-pencil" aria-hidden="true"></i> In-Active</a>
                <?php
              }
              ?>
                                </td>
