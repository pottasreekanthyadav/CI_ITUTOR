      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <h3 class="box-title">Update tutor sub type</h3>
            ...
            <?php
                ...
                echo form_open("superadmin/Tutor_newtype/update_tutor_subtype/$result->tutor_type_id",$form_attributes);
            ?>
               <?php
                ...
                <?php echo form_label('Category Type');
                            ...
                            <select name="category" id="cat" class="form-control ">
                               ...
                               <?php 
                                  ...
                                  {
                                    ?>
                                <option value="<?php echo $row1->category_id;?>"<?php if($row1->category_id==$result->category_id){echo "selected";}?>><?php echo ucwords($row1->category_name);?></option>
                                    <?php
                                  }
                                ?>
                            </select>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <?php echo form_label('Tutor Type');
                            ?>
                            <span style="color:red; " id="tutor_type_err"> *<?php echo form_error('tutor_type');?></span>
                            <select name="tutor_type" id="tutor_type" class="form-control ">
                               ...
                               <?php 
                                  ...
                                  {
                                    ?>
                                   <option value="<?php echo $row->id;?>"<?php if($row->id==$result->type_name){echo "selected";}?>><?php echo ucwords($row->tutor_type);?></option>
                                    <?php
                                  }
                                ?>
                            </select>
...
<script src="<?php echo SUPER_JS_PATH; ?>demo.js"></script>
 ...
 <script>
         $("#btn_submit").click(function(){
           //alert('hai');
             var cat=$('#cat').val();
            var tutor=$('#tutor_type').val();
            var str=true;
      if(cat==''|| cat==' '){
                str=false;
                $('#cat').css('border','1px solid red');
                $('#cat_err').css('color','red');
                $('#cat_err').html(' Please select Class');
            }
            
            if(tutor==''|| tutor==' '){
                str=false;
                $('#tutor_type').css('border','1px solid red');
                $('#tutor_type_err').css('color','red');
                $('#tutor_type_err').html(' Please Enter qualification');
            }
             return str;
         });
