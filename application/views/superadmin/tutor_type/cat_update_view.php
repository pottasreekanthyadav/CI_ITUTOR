              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  $page=$this->uri->segment(4);
                        ...
                        foreach($cat_recs as $row)
                        {
                          ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" </td>
                                        <td><?php echo $i; ?> </td>
...
<td></td>
                                        <td>
                                            <a href="" class="btn btn-sm btn-warning "> Update <i class="glyphicon glyphicon-upload"> </i> </a> <a href="<?php echo base_url();?>admin/categories/cat_delete_ctrl/<?php echo $row->category_id;?>" onclick="javascript:return confirm('Are you sure to delete');" class="btn btn-danger btn-xs "><i class="fa fa-trash-o" aria-hidden="true"></i> Delete </a>
