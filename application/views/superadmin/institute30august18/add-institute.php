...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="institutename" name="institutename" type="text" placeholder="Enter Institute Name" class="form-control input-md" required="" value="<?php echo set_value('institutename'); ?>">
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input id="instituteemail" name="instituteemail" class="form-control input-md" type="text" value="<?php echo set_value('instituteemail'); ?>" placeholder="Enter Institute Email">
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input id="institutemobile" maxlength="10" name="institutemobile" class="form-control input-md" type="text" value="<?php echo set_value('institutemobile'); ?>" placeholder="Enter Institute Mobile">
