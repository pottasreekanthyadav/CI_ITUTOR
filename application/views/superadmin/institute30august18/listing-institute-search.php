...
<option value="<?php echo $value->institute_type_id;?>"><?php echo $value->institute_type_name; ?></option>
          ...
          <div class="col-md-4">          
           <a href="<?php echo base_url('superadmin/Tuitioncenter_controller/add_institute'); ?>"><button  class="btn btn-primary   btn-md">Add</button></a>
                        ...
                        <tbody>
                          <?php
                            ...
                            if (!empty($result)) {
                                foreach ($result as $row) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td><?php echo $row->institute_location; ?></td>
                                         ...
                                         <td><img height="100" width="200" src="<?php echo base_url(); ?>uploads/institutelogo/<?php echo $row->institute_logo; ?>"></td>
                                         <td><?php echo $row->institute_about; ?></td>
                                          <td><?php echo $row->institute_longitude; ?></td>
                                             <td><?php echo $row->institute_latitude; ?></td>
                                         <td><?php echo $row->institute_services; ?></td>
                                ...
                                <tr><td colspan="14" style="text-align:center; color:red;font-size:20px;">No Records Found...</td></tr>
                            <?php }
                            ?>
