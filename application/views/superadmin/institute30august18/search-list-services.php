        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="col-sm-12">
        <form method="post" action="<?php echo base_url();?>superadmin/Tuitioncenter_controller/search_service" class="form-inline">
           <div class="col-sm-2">
...
<option value="<?php echo $value->institute_id;?>"><?php echo $value->institute_name; ?></option>
       ...
       <div class="col-md-4">
           ...
           <a href="<?php echo base_url('superadmin/Tuitioncenter_controller/add_services'); ?>"><button  class="btn btn-primary   btn-md"> Add </button></a>
