  ...
  <div class="col-md-5">
    <select id="institutetype" name="institutetype[]" class="form-control" multiple>
     ...
     if($newinstitute_type->code==SUCCESS_CODE){
      ...
      <option <?php if($value->institute_type_id==$newvar[$v]){echo 'selected="selected"';} ?> value="<?php echo $value->institute_type_id; ?>"><?php echo $value->institute_type_name; ?></option>
      <?php $v++; } } ?>
    </select>
