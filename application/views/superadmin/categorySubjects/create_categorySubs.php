      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <h3 class="box-title">Add Category-Subjects</h3>
            <a href="<?php echo SUPER_ADMIN_FOLDER_PATH;?>categorySubjects/manageCategorySubs" class="btn btn-primary pull-right">Manage Class-Subjects</a>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php
                            $form_attributes = array('id' => 'classSubject', 'name' => 'classSubject');
                            echo form_open('superadmin/CategorySubjects/addCategorySub', $form_attributes);
                         ?>
            <div class="box-body">
              <div class="col-md-4">
            ...
            <?php   $data1 = array(
                        ...
                        echo form_label('Category Name'). "<span style='color:red' id='category_type_err';> *".form_error('category_name')."</span>";
                        echo form_input($data1);?>
                        <span class="err_class" id="category_type_err"></span>
                      </div>
                  </div>
