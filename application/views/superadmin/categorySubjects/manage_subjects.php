                          ...
                          <?php
                            ...
                            if ($data->code == SUCCESS_CODE) {
                                foreach ($data->subjects_list as $row) {
                                    ...
                                    ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->category_sub_id;?>"> </td>
                                        <td><?php echo $i; ?> </td>
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'category', 'updatelist': checklist, 'activity': s},
                url: '<?php echo base_url(); ?>superadmin/CategorySubjects/commonStatus/',
                success: function (u) {
                    console.log(u);
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'category','updatelist':checklist},
