 ...
 <!-- Left side column. contains the logo and sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Add Institute Type vivek</h1>
      <ol class="breadcrumb">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="institutetype" name="institutetype" type="text" placeholder="Enter Type of Institute" class="form-control input-md" value="<?php echo set_value('institutetype'); ?>" onchange="duplicate_restrict()">
   <span id="institutetype-error"><?php echo form_error('institutetype', '<div class="text-danger">', '</div>'); ?></span>
   <p id="duplicate-restrict" style="color: red;"></p>
  </div>
</div>
...
<script type="text/javascript">
  ...
  function duplicate_restrict() {
    ...
    if(institutetype!='' && institutetype!=0){
      $.ajax({
        url:'<?php echo base_url(); ?>superadmin/Tuitioncenter_controller/restrict_institute_type',
        method:'POST',
        dataType:'JSON',
        ...
        success:function(s){
          console.log(s);
          if(s.code==200){
            $("#submitbtnint").prop('disabled',true);
