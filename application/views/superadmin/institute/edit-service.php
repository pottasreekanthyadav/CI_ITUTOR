...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="coursetitle">Ads in category</label>
  <div class="col-md-5">
    <select name="ads" id="ads" class="form-control input-md">
      <option value="0" <?php if($newserviceinfo->right_sidebar_ads==0){ echo 'selected'; } ?>>Choose</option>
      <option value="1" <?php if($newserviceinfo->right_sidebar_ads==1){ echo 'selected'; } ?>>Publish in sidebar</option>
    </select>
     <span id="ads-error"><?php echo form_error('ads', '<div class="text-danger">', '</div>'); ?></span>
  </div>
</div>
<!-- File Button --> 
<div class="form-group">
