  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Institute Types</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
            <a href="<?php echo SUPER_ADMIN_LINK; ?>Tuitioncenter_controller/add_institute_type"><button  class="btn btn-primary" >Add New</button></a>
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  $page=$this->uri->segment(4);
                        ...
                        foreach($cat_recs as $row)
                        {
                          ?>
                                    <tr class="">
                                        <td><input type="checkbox" class="checkbox" name="multiple[]" value="<?php echo $row->institute_type_id;?>"></td>
                                        <td><?php echo $i; ?> </td>
                                        <td><?php echo ucwords($row->institute_type_name); ?></td>
                                        <td><img src="<?php echo base_url(); ?>uploads/institutetypeimage/<?php echo $row->institutetype_image; ?>" width="50px"></td>
                                        <td class="text-success"><b> <?php if ($row->institute_type_status == 1) {
                                ...
                                echo date('d-m-Y',strtotime($row->created_date));?></td>
                                        <td>
                                            <a href="<?php echo base_url();?>superadmin/Tuitioncenter_controller/edit_institute_type/<?php echo $row->institute_type_id;?>" class="btn btn-xs btn-warning "> Update <i class="glyphicon glyphicon-upload"> </i> </a>
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'institutetype', 'updatelist': checklist, 'activity': s},
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'institutetype','updatelist':checklist},
