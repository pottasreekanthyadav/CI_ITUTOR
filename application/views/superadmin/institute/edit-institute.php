...
<head>
  ...
  <title>Itsmytutor | Dashboard</title>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="institutename" name="institutename" type="text" placeholder="Enter Institute Name" class="form-control input-md" required=""  onchange="duplicate_restrict_institutename()" value="<?php echo $dataret->institute_name; ?>">
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input id="instituteemail" name="instituteemail" class="form-control input-md" type="text" value="<?php echo $dataret->institute_email; ?>" onchange="duplicate_restrict_instituteemail()" placeholder="Enter Institute Email">
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input id="institutemobile" maxlength="10" name="institutemobile" class="form-control input-md" type="text" value="<?php echo $dataret->institute_mobile; ?>" placeholder="Enter Institute Mobile" onchange="duplicate_restrict_institutemobile()">
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" id="aboutinstitute" placeholder="Enter Your Text Here.." name="aboutinstitute"><?php echo $dataret->institute_about; ?></textarea>
...
<input type="hidden" id="editid" name="editid" value="<?php echo $dataret->institute_id; ?>">
...
<script type="text/javascript">
 ...
 // alert('hi');
    ...
    if(institutename!='' && institutename!=0){
      $.ajax({
        url:'<?php echo base_url(); ?>superadmin/Tuitioncenter_controller/restrict_institute_name_u',
        method:'POST',
        dataType:'JSON',
        data:{'institutename':institutename,'editid':editid},
        success:function(s){
          console.log(s);
          if(s.code==200){
 ...
 var editid = $("#editid").val();
    ...
    if(instituteemail!='' && instituteemail!=0){
      $.ajax({
        url:'<?php echo base_url(); ?>superadmin/Tuitioncenter_controller/restrict_institute_email_u',
        method:'POST',
        dataType:'JSON',
        data:{'instituteemail':instituteemail,'editid':editid},
        success:function(s){
          console.log(s);
          if(s.code==200){
            $("#submit").prop('disabled',true);
 ...
 var editid = $("#editid").val();
    ...
    if(institutemobile!='' && institutemobile!=0){
      $.ajax({
        url:'<?php echo base_url(); ?>superadmin/Tuitioncenter_controller/restrict_institute_mobile_u',
        method:'POST',
        dataType:'JSON',
        data:{'institutemobile':institutemobile,'editid':editid},
        success:function(s){
          console.log(s);
          if(s.code==200){
            $("#submit").prop('disabled',true);
