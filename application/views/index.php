...
<title> Home Tuitions | Home Tutors Providers in hyderabad -<?php echo TITLE_PATH;?>  </title>
...
-->
  ...
  <h5 class="col-wh"> 1000 /-</h5>
        </div>
        <div class="col-sm-7 col-xs-6">
          <h2 class="m-t-16">Pay Once and use Lifetime <a href="<?php echo base_url();?>tuition-center" class="pay-more"><span class="f14">Know more</span></a></h2>
        </div>
        <div class="col-sm-4 col-xs-2">
          <button type="button" class="btn btn-danger3 no-bod-rad  col-sm-8 col-sm-offset-2" style="margin-top: 16px;" onclick="navigate_now();">Start Now</button>
        </div>
      </div>
    </div>
  </section>

<!--why its my tutor start  for parent section start-->

 <section class="whytutor">
 <div class="container">
   <div class="col-md-12">
       <div class="clearfix">&nbsp;</div>
     <h2 class="text-center"><b>Why <span class="tl-site">Itsmytutor </span> - Parents</b></h2>
...
-->
       ...
       <div class="col-md-4 col-xs-12">
            <div class="col-md-12 whytutor-mian no-padd">
                <div class="col-md-3 col-xs-3">
                  <img src="<?php echo MYIMAGES_PATH;?>whyits/mobile-app-services.png" alt="itutors"/>
                </div>
                <div class="col-md-9 col-xs-9">
       ...
       <div class="col-md-4 col-xs-12">
            <div class="col-md-12 whytutor-mian no-padd">
                ...
                <h4>Unique Subscription</h4>
                  <p><b>One time subscription fee for the services offered to you <!--any where in--> through out India</b></p>
                    </div>
                <div class="clearfix"></div>
            </div>
            <div class="clearfix"></div>
...
<!--why its my tutor start  for parent section end-->
  ...
  <section>
   ...
   <div class="container">
     <div class="col-sm-12 text-center">
             <div class="clearfix">&nbsp;</div>
       <h2 class="text-center"><b>Find tutors with <a href="<?php echo base_url();?>signup"><span class="tl-site">Itsmytutor</span></a> App </b></h2>
          <div class="clearfix">&nbsp;</div> <div class="clearfix">&nbsp;</div>
         <img src="<?php echo MYIMAGES_PATH;?>mobile-app-parent.png" class="img-responsive" style="display: inline;">
         <div class="clearfix">&nbsp;</div>
          <a href="#" target="_blank"><img src="<?php echo MYIMAGES_PATH;?>google.png"></a>
         <a href="#" target="_blank"><img src="<?php echo MYIMAGES_PATH;?>apple.png"></a>
         <div class="clearfix">&nbsp;</div> <div class="clearfix">&nbsp;</div>
    </div>
   </div>
   </div>
...
<!--Section how it works Start-->
  ...
  <section>
   ...
   <div class="container">
     <div class="col-sm-12 text-center">
             <div class="clearfix">&nbsp;</div>
       <h2 class="text-center"><b>How it Works - <span class="tl-site">Parents</span> </b></h2>
          <div class="clearfix">&nbsp;</div> <div class="clearfix">&nbsp;</div>
         <img src="<?php echo MYIMAGES_PATH;?>howitworks-parent.png" class="img-responsive" style="display: inline;">
         <div class="clearfix">&nbsp;</div>
...
<!--Section how it works End-->
  ...
  <div class="clearfix"></div>
  <section class="banner-list hidden">
        <div class="container">
            <div class="col-md-12">
              <div class="clearfix">&nbsp;</div>
               <div class="clearfix">&nbsp;</div>
...
<!--                       <div class="col-sm-3 text-center"><img src="<?php echo MYIMAGES_PATH;?>subjects.png" alt="tutors"/> <p class="f18"><b>&nbsp;Over <span class="tl-site">35</span> Subjects</b></p></div>-->
 ...
 <section class="student-succcess">
   <div class="container">
     <div class="col-md-12">
     <h2 class="text-center col-wh"> <b>Parent's Success Stories</b></h2>
       <div class="col-md-12" data-wow-delay="0.2s">
                        <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                            <!-- Bottom Carousel Indicators -->
                               <!--   <ol class="carousel-indicators">
                                <li data-target="#quote-carousel" data-slide-to="0" class="active"><img class="img-responsive " src="<?php  echo MYIMAGES_PATH;?>s1.jpg" alt="">
                                </li>
                                <li data-target="#quote-carousel" data-slide-to="1"><img class="img-responsive" src="<?php  echo MYIMAGES_PATH;?>s2.jpeg" alt="">
                                </li>
                                <li data-target="#quote-carousel" data-slide-to="2"><img class="img-responsive" src="<?php  echo MYIMAGES_PATH;?>s3.jpg" alt="">
                                </li>
                            </ol> -->
                            ...
                            <div class="carousel-inner text-center carousel-hgh">
                                    ...
                                    <blockquote>
                                        <div class="row">
                                            <div class="col-sm-8 col-sm-offset-2">
                                              <p>My son aarush has so much potential but was performing poor in maths, only due to lack of individual training. Itsmytutor.com helped us to find one good tutor who helped him a lot. Now he is performing very well.</p>
                                                <small> Parent of class IX </small>
                                            </div>
                                        </div>
                                    </blockquote>
                                </div>
                                ...
                                <div class="item">
                                    <blockquote>
                                        <div class="row">
                                            <div class="col-sm-8 col-sm-offset-2">
                                             <p>Itsmytutor.com helped us to find  an excellent home tutor with in depth subject knowledge and lots patience </p>
                                                <small>Parent of class III</small>
                                            </div>
                                        </div>
                                    </blockquote>
                                </div>
                                ...
                                <div class="item">
                                    <blockquote>
                                        <div class="row">
                                            <div class="col-sm-8 col-sm-offset-2">
                                            <p>Thanks to the Brilliant home tuitions provided by Itsmytutor.com, I was able to score 89% in 12th. This was way above what I scored usually……my parents were extremely happy. Tutor that we got at the last moment during the exam was outstanding (we had only three months to go before the exam started). I only regret that I should have taken this service much earlier.</p>
                                                <small>Rahul,
   Class xi,
   Hyderabad</small>
                                            </div>
 ...
 <section class="popular">
   <div class="container">
     <div class="col-md-12">
        <h2 class="text-center"><b>Popular Subjects</b></h2>
        <div class="clearfix">&nbsp;</div>  <div class="clearfix">&nbsp;</div>
          <div class="col-md-3">
...
-->
 ...
 <section class="tutor-testmonial">
   <div class="col-md-12 no-pad">
       <div class="col-md-6 tutor-testmonial-left hidden">
       <div class="col-sm-10 col-md-push-2">
       <div class="clearfix">&nbsp;</div>
         <h4><span> Student's Testmonials </span></h4>
         <div class="clearfix">&nbsp;</div>
    ...
    <div class='col-md-12'>
         ...
         <div class="carousel-inner" style="min-height:200px !important;">
          ...
          <div class="item active">
            <blockquote>
              ...
              <!--   <div class="col-sm-3 text-center">
                  <img class="img-circle" src="<?php echo MYIMAGES_PATH;?>s4.jpg" style="width: 100px;height:100px;">
          ...
          <div class="item">
            <blockquote>
              <div class="row">
               <!--  <div class="col-sm-3 text-center">
                  <img class="img-circle" src="<?php echo MYIMAGES_PATH;?>s5.jpg" style="width: 100px;height:100px;">
                </div> -->
                <div class="col-sm-12">
          ...
          <div class="item">
            <blockquote>
              <div class="row">
              <!--   <div class="col-sm-3 text-center">
                  <img class="img-circle" src="<?php echo MYIMAGES_PATH;?>s6.jpg" style="width: 100px;height:100px;">
                </div> -->
                <div class="col-sm-12">
     ...
     <div class="col-md-12 no-pad">
       <div class="col-md-12 tutor-testmonial-right">
          ...
          <h4 style="margin-top:15px">Hey tutors!!  Are you sick of paying thousands of rupees for single tution as a commission.?</h4>
          <h5>  Welcome to <span class="label label-primary"><a href="<?php echo base_url();?>signup" style="color: #fff"><b>itsmytutor.com</b></a></span> &nbsp; where you will get endless tuitions at a one time subscription fee. First of it's kind in India.    So are you excited to earn handsome money with zero commission? Join our tutor community now!</h5>
          <div class="clearfix"></div>
          <a href="<?php base_url();?>tutor/welcome-page" class="btn btn-primary col-wh no-bod-rad btn-md"> &nbsp; Join as a Tutor &nbsp; </a>
          <div class="clearfix"></div>
          </div>
       </div>
     </div>
