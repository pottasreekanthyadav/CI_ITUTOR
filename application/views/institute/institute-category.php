...
<link rel="canonical" href="http://itsmytutor.com/activity"/>
...
//print_r($institute);die;
          ...
          <div class="col-sm-3">
            <div class="cat-list-adj">
               <a href="<?php echo base_url(); ?>institute-listing/<?php echo  $title; ?>/<?php echo base64_encode($value->institute_type_id); ?>"><img src="<?php echo base_url();?>uploads/institutetypeimage/<?php echo $value->institutetype_image; ?>" class="img-responsive" style="width:100%;" alt="itutors" /></a>
               <h4><b> &nbsp;  <a href="<?php echo base_url(); ?>institute-listing/<?php echo  $title; ?>/<?php echo base64_encode($value->institute_type_id); ?>"><?php echo $value->institute_type_name; ?></a></b></h4>
               <p> &nbsp; 15 tutors</p>
            </div> 
          </div>
     <?php           }
