...
?>
      <?php if($k==0){?>
               <li class="wishlist" value="<?php echo $row->book_id;?>" onclick="getwid(this.value)">
...
xhttp.open("GET", "<?php echo base_url();?>rentabook/frontend/indexwishlist/"+wid, true);// true is for asynchronus and false synchronus
xhttp.send();
