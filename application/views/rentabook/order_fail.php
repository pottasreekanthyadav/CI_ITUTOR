        ...
        <div class="col-sm-12">
         <div class="row">
            <div class="col-sm-12 text-center">
                <img src="<?php echo base_url();?>assets/images/payment_failure.png" class="img-responsive m-t-20" style="display:inline">
                <h2 class="text-danger"> Your order has been failure</h2>
