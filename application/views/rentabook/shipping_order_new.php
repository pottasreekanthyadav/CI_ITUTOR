         ...
         <div class="row">
            ...
            <?php $shipping=$ship->row();?>
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control no-bod-rad" placeholder="Enter Your Name" value="<?php  echo $ship_details->name;?>" id="name" value="<?php echo set_value('name'); ?>">
                </div>
                        </div>
                <div class="form-group col-sm-5">
                    <label>Mobile</label> <span style="color:red;" id="mobile_err"><?php echo form_error('mobile');?></span>
                    <input type="text" class="form-control no-bod-rad" placeholder="Enter Your Mobile" value="<?php echo $ship_details->mobileno;?>" name="mobile" id="mobile"  maxlength="10" value="<?php echo set_value('mobile'); ?>">
                </div> 
                    <div class="col-sm-offset-1 col-sm-5">
                <div class="form-group">
                    <label>Email</label> <span style="color:red;" id="email_err"><?php echo form_error('email');?></span>
                    <input type="email" class="form-control no-bod-rad" placeholder="Enter Your Email" name="email" id="email" value="<?php echo $ship_details->email;?>">
                   
                </div>
                        </div>
                <div class="form-group col-sm-5">
                    <label>Locality</label> <span style="color:red;" id="locality_err"><?php echo form_error('locality');?></span>
                    <input type="text" class="form-control no-bod-rad" placeholder="Enter Your Locality" name="locality" id="locality" value="<?php echo $ship_details->locality;?>">
                </div>
                <div class="col-sm-offset-1 col-sm-5">
                     <label>Pincode</label> <span style="color:red;" id="pincode_err"> <?php echo form_error('pincode');?></span>
                    <input type="text" class="form-control no-bod-rad" placeholder="Enter Your Pincode" name="pincode" id="pincode" maxlength="6" value="<?php echo $ship_details->pincode; ?>">
                </div>
                    <div class="form-group col-sm-5">
                <div class="form-group">
                    <label>Landmark</label> <span style="color:red;" id=""></span>
                    <input type="text" class="form-control no-bod-rad" placeholder="Enter Your Landmark (optional)" name="landmark" value="<?php echo $ship_details->landmark; ?>">
                </div>
                        </div>
                <div class="col-sm-offset-1 col-sm-5">
                    <label>Alternate Mobile</label> <span style="color:red;" id="mobile1_err"><?php echo form_error('lmobile');?></span>
                    <input type="text" class="form-control no-bod-rad" placeholder="Enter Mobile No. (optional)" name="lmobile" id="mobile1" maxlength="10" value="<?php if($ship_details->almobile!=0) echo $ship_details->almobile; ?>">
                </div> 
                   <div class="col-sm-offset-1 col-sm-10">
                <div class="form-group">
                    <label>Address</label> <span style="color:red;" id="address_err"><?php echo form_error('address');?></span>
                  <textarea class="form-control no-bod-rad" rows="3" style="resize:none" placeholder="Enter your Address" name="address" id="address"><?php echo $ship_details->address;?></textarea>
                </div>
                        </div>
                    <div class="col-sm-offset-1 col-sm-10">
                    <div class="form-group">
