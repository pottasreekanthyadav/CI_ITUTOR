...
<div class="col-sm-12">
 ...
 <address>
     <?php echo $shipDetailResult->address; ?>
      </address>
 </div>
<div class="col-sm-3">
 <h4><b>PAYMENT METHOD</b></h4> 
<?php if($shipDetailResult->payment_type == 1){ ?>
<p>Cash On Delivery</p>
<?php }elseif ($shipDetailResult->payment_type == 1) {?>
<p>Online</p>
<?php } ?>
</div>
<div class="col-sm-4">
...
<div class="row">
 ...
 <div class="col-sm-4">
     <h5><b> : <?php echo $shipDetailResult->total_qty;?></b></h5>   
     <h5><b> : <i class="fa fa-inr" aria-hidden="true"></i> <?php echo ($shipDetailResult->subtotal_amt)-($totalShipAmt->shipping_charge);?></b></h5>   
     <h5><b> : <i class="fa fa-inr" aria-hidden="true"></i> <?php echo $totalShipAmt->shipping_charge ?></b></h5>   
     <h5><b> : <i class="fa fa-inr" aria-hidden="true"></i> <?php echo $shipDetailResult->discount_amt;?></b></h5>   
     <h5><b> : <i class="fa fa-inr" aria-hidden="true"></i> <?php echo $shipDetailResult->total_amt;?></b></h5> 
     <h5>&nbsp;</h5>
 </div>    
</div>
</div>
  ...
  <table width="100%" class="table table-striped table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          <?php
                          if(!empty($orderDetailResult)){
                           foreach ($orderDetailResult as $row) {
                          ?>
                    <tr>
