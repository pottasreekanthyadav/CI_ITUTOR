...
<div class="col-sm-12">
  ...
  <table width="100%" class="table table-striped table-hover" id="dataTables-example">
                    ...
                    <tr>
                      ...
                      <td><?php if($row->payment_type == 1){echo "Cash on delivery";}
                                elseif ($row->payment_type == 2) {echo "Online";}  
                       ?></td>          
                      <td><a href="<?php echo base_url().'book/orderdetails/'.base64_encode($row->order_id)?>" class="btn btn-success">View Details</a></td>        
                    </tr>
                  <?php } 
                }else{
                  ?>
                    <tr><td colspan="6" align="center"><b>You have no previous orders</b></td></tr>
<?php } ?>
                        </tbody>
