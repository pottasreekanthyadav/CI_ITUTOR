	...
	public function upload ($lang='english')
	{
		...
		if ($this->upload->do_upload()) // Success
		{
			...
			{				
				...
				$resizeParams = array
				(
					'source_image'	=> $result[$_SERVER['DOCUMENT_ROOT'] . '/wowwin/admin_assets/uploads/questions' ],
					'new_image'		=> $result[$_SERVER['DOCUMENT_ROOT'] . '/wowwin/admin_assets/uploads/questions/compressed'],
					'width'			=> $conf['50'],
					'height'		=> $conf['50']
				);				
				// Load resize library
